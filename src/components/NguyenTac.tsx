                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-12">
                            ...
                            <div className="single-features">
                                ...
                                <h3>Trách Nhiệm</h3>
                                <p>
                                    Chúng tôi cam kết chịu trách nhiệm với từng quyết định y khoa, đảm bảo sự an toàn và tin cậy cho khách hàng.
                                </p>
                            </div>
                            {/* End Single features */}
                        </div>
                        <div className="col-lg-3 col-12">
                            ...
                            <div className="single-features">
                                ...
                                <h3>Công Bằng</h3>
                                <p>
                                    Chúng tôi đối xử công bằng, tôn trọng mọi khách hàng và cộng đồng, không phân biệt hoàn cảnh hay điều kiện.
                                </p>
                            </div>
                            {/* End Single features */}
                        </div>
                        <div className="col-lg-3 col-12">
                            ...
                            <div className="single-features last">
                                ...
                                <h3>Thấu Hiểu</h3>
                                <p>
                                    Chúng tôi luôn lắng nghe, đồng cảm với nỗi lo của khách hàng, mang đến sự chăm sóc tận tâm và chu đáo nhất.
                                </p>
                            </div>
                            {/* End Single features */}
                        </div>
